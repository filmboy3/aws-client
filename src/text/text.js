export const text = [
  ...
  "Will you and your team help navigate Jonathan's safe passage to the L2 frontier, forged by this brave pioneer?", 
  `{scottStatic}`,
  ...
  // 4
   ...
   `Press 'y' or 'n'`],
   // 5
   ["Please list any/all of your favorite casual eateries in NYC",
